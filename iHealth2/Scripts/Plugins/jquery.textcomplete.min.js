...
return lineHeight}});$.fn.textcomplete.Textarea=Textarea}(jQuery);+function($){'use strict';var sentinelChar='å¶';function IETextarea(element,completer,option){this.initialize(element,completer,option);$('<span>'+sentinelChar+'</span>').css({position:'absolute',top:-9999,left:-9999}).insertBefore(element)}
